export const NotificationService = {
  show({
    ...
    const typeClassMap = {
      ...
      info: "border border-indigo-500/20 bg-indigo-500/10 text-indigo-800/80 dark:text-indigo-400",
    };
    const typeTimerMap = {
      ...
      info: "bg-indigo-400/20 text-indigo-800/80 dark:text-indigo-400",
    };
    const typeUndoMap = {
      success: "bg-emerald-400/20 hover:emerald-500/20",
      error: "bg-red-400/20 hover:red-500/20",
      warning: "bg-amber-400/20 hover:amber-500/20",
      info: "bg-indigo-400/20 hover:indigo-500/20",
    };
    ...
    const typeTextColorMap = {
      ...
      info: "text-indigo-800/80 dark:text-indigo-500",
    };
