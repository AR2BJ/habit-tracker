      ...
      >
        <div class="bg-surface rounded-2xl p-6 max-w-sm w-full shadow-xl flex flex-col gap-4">
          ...
          <input
            ...
            type="text"
            maxlength="50"
            class="w-full mt-2 px-4 py-3 rounded-xl bg-surface-2 border border-border text-primary placeholder:text-secondary outline-none focus:ring-2 focus:ring-brand"
          />
