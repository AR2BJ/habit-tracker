  ...
  render() {
    return `
      ...
      >
        ...
        >
          <div
            class="w-12 h-12 rounded-full bg-red-500/10 text-red-500 flex items-center justify-center text-xl mx-auto"
          >
          ...
          <div class="grid grid-cols-2 gap-3 mt-2">
            ...
            <button
              ...
              class="px-4 py-2.5 rounded-xl bg-red-600 hover:bg-red-800 text-white font-medium text-sm transition shadow-sm cursor-pointer"
            >
              Yes, Wipe Out
            </button>
          </div>
